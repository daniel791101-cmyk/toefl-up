...
import { RECENT_PRACTICES } from '../constants';
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {RECENT_PRACTICES.map((practice) => (
               <div key={practice.id} className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col gap-4">
                  ...
                  <button className="w-full py-2 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary-dark transition-colors mt-2">
                     View Report
                  </button>
               </div>
            ))}
